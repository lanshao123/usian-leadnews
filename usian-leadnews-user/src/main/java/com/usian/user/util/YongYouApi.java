...
public class YongYouApi {
    ...
    //3.活体检测
    public static String biologicalexamination() {
        String result = null;
        String url = "https://api.yonyoucloud.com/apis/dst/Biologicalexamination/Biologicalexamination";//请求接口地址
        String method = "POST";
        String paramFormat = "form";
        Map<String, Object> params = new HashMap<String, Object>();//请求参数
        params.put("image", "https://hmtt122.oss-cn-shanghai.aliyuncs.com/222.png");
        params.put("imageType", "URL");

        Map<String, Object> headerParams = new HashMap<String, Object>();//请求头参数
        headerParams.put("apicode", "f1e164327ded46ee90ab7987fc628d55");//APICODE
        headerParams.put("Content-Type", "application/json");
    ...
    //4.人证核验
    public static String comparisonsofPersonsandDocuments (){
        String result =null;
        String url ="https://api.yonyoucloud.com/apis/dst/ComparisonsofPersonsandDocuments/ComparisonsofPersonsandDocuments";//请求接口地址
        String method = "POST";
        String paramFormat = "form";
        Map<String, Object> params = new HashMap<String, Object>();//请求参数
        params.put("liveImage", "https://hmtt122.oss-cn-shanghai.aliyuncs.com/222.png");
        params.put("idCardImage", "https://hmtt122.oss-cn-shanghai.aliyuncs.com/demo_idcard.png");
        params.put("imageType", "URL");

        Map<String, Object> headerParams = new HashMap<String, Object>();//请求头参数
        headerParams.put("apicode", "698af82b155a4e15884d41d45df96518");//APICODE
        headerParams.put("Content-Type", "application/json");
