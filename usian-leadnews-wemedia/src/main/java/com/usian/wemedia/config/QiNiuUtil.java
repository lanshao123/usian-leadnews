...
public class QiNiuUtil {
    ...
    /**
     * 删除文件
     * @param fileName 删除文件文件云端存储的名称
     * @return
     * @throws UnsupportedEncodingException
     */
    public static String deleteUrl(String fileName) throws UnsupportedEncodingException {
        //构造一个带指定Zone对象的配置类
        Configuration cfg = new Configuration(QiNiuConfig.getInstance().getZone());
        ...
        try {
            bucketManager.delete("usian-wangheng", fileName);
            return "success";
        } catch (QiniuException e) {
            e.printStackTrace();
        }
